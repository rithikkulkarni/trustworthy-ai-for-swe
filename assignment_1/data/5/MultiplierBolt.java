...
//            SampleEncoder sampleEncoder = new SampleEncoder(stateFileName, "9001", "192.168.31.117", "9001", "10");
            // Save state to db.
//            SaveStateToDB saveStateToDB = new SaveStateToDB(stateFileName);
            // Save state directly to Past.
//            SaveStateToPAST saveStateToPAST = new SaveStateToPAST(stateFileName, "9001", "192.168.31.117", "9001", "10");
            // Save state to HDFS.
